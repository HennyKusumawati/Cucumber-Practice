...
public class EmployeeSearchSteps extends CommonMethods {
    ...
    public void user_enters_valid_employee_id() {
      //  WebElement empIdSearchField= driver.findElement(By.cssSelector("input#empsearch_id"));
        sendText("34567", employeeSearchPage.empIdSearch);
    }
  ...
  //  WebElement empNameSearch= driver.findElement(By.id("empsearch_employee_name_empName"));
    sendText("Amanda", employeeSearchPage.empNameSearch);
    }
}
